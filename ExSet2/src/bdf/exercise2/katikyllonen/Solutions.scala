...
object Solutions {
  ...
  def exercise4a (sc: SparkContext, rdd: RDD[(Int, ((String, Int, Int), Iterable[(String, String, Int)]))]): RDD[(Int, Array[(String, Float)])] = {
          //userID,(Gender, Age, Occupation)(Title, Genre, Rating)...
  ...
  def exercise4b (tenMoviesByAge:RDD[(Int,Array[(String,Float)])]) {
